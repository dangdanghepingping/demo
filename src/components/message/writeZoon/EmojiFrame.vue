<template>
  <div class="frFrame" @mouseenter="showBar" @mouseleave="disShowBar" @mousewheel="mouseWheel">
    <div class="demo" ref="demo" v-bind:style="{top: -demoTop + 'px'}">
      <ImageBlock @disppearEmoji='disppearEmoji' :emojiId='emojiId'></ImageBlock>
    </div>
