  ...
  <div class="wrapper center flex flex_col">
    <div class="content flex flex_al_center flex_ju_aroud flex_col">
      ...
      <!-- <div class="nickName">
        <p class="writeZoo">
          <span>昵称:</span>
          <input v-model="nickName" type="text" placeholder="长度为2到6之间的非纯数字" />
        </p>
      ...
      <div class="flexCenter marginTop">
        ...
        <p class="right">
          <input v-model="wxId" v-if="$route.name=='register'" type="text" placeholder="长度不能少于6位数" />
...
<script>
import UploadImg from "../components/rigister/UploadImg";
